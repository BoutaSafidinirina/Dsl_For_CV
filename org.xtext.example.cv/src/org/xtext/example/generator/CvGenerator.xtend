            ...
            <body>
                ...
                <section class="education">
                    ...
                    <ul>
                       ...
                       «FOR education : cv.education»
                              <li>«education.degree» - «education.university» ('«education.year»')</li>
                       «ENDFOR»
                    </ul>
                </section>
                ...
                <section class="experience">
                    ...
                    <ul>
                      «FOR experience : cv.experience»
                            <li>«experience.position» - «experience.company» ('«experience.year»')</li>
                       «ENDFOR»
                    </ul>
                </section>
